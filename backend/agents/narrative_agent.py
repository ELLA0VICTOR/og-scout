...
AGENT_NAME = "Narrative & Team Credibility"

SYSTEM_PROMPT = """You are a Web3 project credibility analyst specializing in team assessment and narrative verification.
Analyze the given project for the gap between its stated mission and actual delivery, team anonymity risks,
social proof authenticity, roadmap execution history, and influencer/marketing manipulation signals.
...
def run(target: str) -> dict:
    ...
    user_prompt = f"""Analyze this Web3 project for narrative credibility and team integrity:
...
3. FINDINGS: 2-3 paragraph detailed analysis covering:
   - Whitepaper vs delivered product comparison (promise-vs-reality gap)
   - Team anonymity level and verifiable track record
   - Social media credibility and bot/shill activity signals
   - Roadmap delivery history and milestone execution
   - Marketing tactics (paid influencers, artificial hype, FOMO engineering)
